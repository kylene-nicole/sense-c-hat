...
class Radar:
    ...
    def radar_api_config(self):
        ...
        # # INIT JSON
        # data_for_send_str = 'OJ' + '\n'
        # data_for_send_bytes = str.encode(data_for_send_str)
        # self.radar.write(data_for_send_bytes)

        # # INIT FMCW RAW DATA
        # data_for_send_str = 'oR' + '\n'
        # data_for_send_bytes = str.encode(data_for_send_str)
        # self.radar.write(data_for_send_bytes)

        # # INIT FMCW Magnitudes
        # data_for_send_str = 'oM' + '\n'
        # data_for_send_bytes = str.encode(data_for_send_str)
        # self.radar.write(data_for_send_bytes)

        # # INIT SPEED VALUES
        # data_for_send_str = 'OS' + '\n'
        # data_for_send_bytes = str.encode(data_for_send_str)
        # self.radar.write(data_for_send_bytes)

        # # INIT FFT
        # data_for_send_str = 'oF' + '\n'
        # data_for_send_bytes = str.encode(data_for_send_str)
        # self.radar.write(data_for_send_bytes)
        ...
        # # INIT POWER ON
        # data_for_send_str = 'PA' + '\n'
        # data_for_send_bytes = str.encode(data_for_send_str)
        # self.radar.write(data_for_send_bytes)

        logging.debug("[DEBUG] Radar initialized")
...
def start_radar_data_collection(station_number):
    ...
    for port in radar_ports:
        logging.debug(f"[DEBUG] Serial port: {port}")
        radar = Radar(port, station_number) #, freq_key, freq_val)
        print(f"Starting data collection on {port}...")
        radar.collect_and_save_data()
        radar.radar.close()
        logging.debug(f"[DEBUG] Closing radar port: {port}")
    print("Success - Closing all radar ports on station", station_number)
    return "Pass"

# TODO - multiple stations, multiple scans a/b/c, deploy to testing techs - change time duration or multitude